...
STRUCTURED_NATIVE_SOURCES = {
    ...
    "stock_strategy_smart_line",
    "ema_strategy_reference",
    "a_share_strategy_research",
    "eastmoney_block_trade",
    "sse_block_trade",
    "pbc_credit_data",
    "stats_china_money_supply",
    "cnfin_macro_policy",
    ...
    "investing_crude_oil",
    "cninfo_stock_code_lookup",
    "eastmoney_stock_code_lookup",
    "investing_gold",
    "eastmoney_gold_etf",
    ...
    "auction_limit_up_strategy",
    "a_share_bull_stock_review",
    "beer_seasonality_sector",
    "nasdaq_big_tech",
    ...
    "data_center_idc_sector",
    "new_energy_storage_sector",
    "power_sector_policy",
    "consumer_valuation_sector",
    "mining_geopolitics_sector",
    "stock_theme_research",
    "jpx_topix_etf",
    "reuters_global_markets",
    "jpmorgan_global_outlook",
    "yahoo_global_markets",
    "cfmoto_powersports",
    "eastmoney_cfmoto_profile",
    "csindex_star50",
